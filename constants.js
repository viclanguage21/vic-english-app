...
// Badge text translations — keyed by lang → badge id → {name?, desc?}
// PT is the default stored in BADGES; only non-PT langs needed here.
export const BADGE_TRANSLATIONS = {
  en: {
    _cat: { momento:"⚡ Moment", performance:"🔥 Performance", resiliencia:"⚔️ Resilience",
            dominio:"🧠 Mastery", raro:"👑 Rare", jogos:"🎮 Games", segmento:"🗺️ Segment" },
    first_mission:  { desc:"Completed your first mission. The journey begins here!" },
    first_perfect:  { desc:"5 perfect answers. Pure magic!" },
    first_voice:    { desc:"Used the mic for the first time. Your voice rules!" },
    first_game:     { desc:"Played your first game (memory, flashcards or dialogue)." },
    first_writing:  { desc:"Wrote your first essay in English." },
    games3:         { desc:"3 full games. You're getting the hang of it!" },
    games6:         { desc:"6 games — you know how to handle the open sea!" },
    games10:        { desc:"10 games — unstoppable! Officially promoted to First Mate." },
    games15:        { desc:"15 games — rough seas don't scare you anymore." },
    games25:        { desc:"25 games — a seasoned veteran of English seas!" },
    games40:        { desc:"40 games — you command the fleet now, Admiral!" },
    memory5:        { desc:"5 memory games — each pair is a perfectly stacked container." },
    flashcard10:    { desc:"10 flashcard decks — signals received and answered!" },
    dialogue5:      { desc:"5 dialogues — communication established loud and clear!" },
    streak3:        { desc:"25 correct in a row. You and English: made for each other!" },
    streak5:        { desc:"60 in a row — the Bee Gees approve!" },
    streak10:       { desc:"120 in a row — Tony Stark approves." },
    xp100:          { desc:"100 XP — only the worthy reach this point!" },
    xp250:          { desc:"250 XP — your sixth sense for English has awakened!" },
    xp500:          { desc:"500 XP — you make it happen. There's no stopping you now!" },
    missions3:      { desc:"3 missions — Hogwarts letter accepted, wizard!" },
    missions10:     { desc:"10 missions — worthy of Mount Doom!" },
    daily3:         { desc:"3 days in a row — the team is assembling." },
    daily7:         { desc:"7 days in a row — Queen would approve. Buddy, you're a champion!" },
    daily14:        { desc:"14 days in a row — Captain America would approve. You never give up!" },
    daily30:        { desc:"30 days in a row — Stan Lee would be proud. Excelsior!" },
    missions5:      { desc:"5 missions — Michael Jackson showed up. Cause this is Thriller!" },
    xp1000:         { desc:"1000 XP — the power of the universe in your hands!" },
    dom_maritimo:   { desc:"Mastered Maritime — captain certified!" },
    dom_comex:      { desc:"Mastered COMEX — the world is your market." },
    dom_offshore:   { desc:"Mastered Offshore — no platform holds any secrets!" },
    dom_hotelaria:  { desc:"Mastered Hospitality — international guests, welcome!" },
    dom_restaurante:{ desc:"Mastered Restaurants — orders flowing in English!" },
    dom_aeroporto:  { desc:"Mastered Airport — passengers served with excellence!" },
    dom_cruzeiro:   { desc:"Mastered Cruises — fun on board guaranteed!" },
    dom_corporativo:{ desc:"Mastered Corporate — English meetings, no fear!" },
    dom_saude:      { desc:"Mastered Healthcare — precise communication saves lives!" },
    dom_transporte: { desc:"Mastered Transport — route charted in English!" },
    dom_varejo:     { desc:"Mastered Retail — international sales unlocked!" },
    dom_santos:     { desc:"Mastered Santos Tourism — city on the global map!" },
    polyglot:       { desc:"3+ segments — 'There is no spoon.' — Neo" },
    fleet:          { desc:"6+ segments — you command entire fleets!" },
    all_games:      { desc:"Played every type of game at least once." },
    xp2500:         { desc:"2500 XP — absolute legend. No hero has come this far!" },
    missions50:     { desc:"50 missions — Ulysses has returned home." },
    seg_maritimo_1: { name:"Maritime: First Steps",       desc:"On deck. Your maritime English journey begins!" },
    seg_maritimo_3: { name:"Maritime: Officer in Training",desc:"3 Maritime missions. Port English is flowing!" },
    seg_hotelaria_1:{ name:"Hospitality: Check-in Done",  desc:"First Hospitality mission. Welcome, guest — the hotel awaits!" },
    seg_hotelaria_3:{ name:"Hospitality: Trainee Receptionist", desc:"3 Hospitality missions. International guests, you've got this!" },
    seg_restaurantes_1:{ name:"Restaurants: Table Reserved", desc:"First Restaurants mission. The menu in English is open!" },
    seg_restaurantes_3:{ name:"Restaurants: Trainee Waiter",  desc:"3 Restaurants missions. English orders at the tip of your tongue!" },
    seg_turismo_1:  { name:"Santos Tourism: Welcome",     desc:"First Santos Tourism mission. Santos on the global map!" },
    seg_turismo_3:  { name:"Santos Tourism: Guide in Training", desc:"3 Tourism missions. You're presenting Santos to the world!" },
    seg_comex_1:    { name:"COMEX: Junior Operator",      desc:"First COMEX mission. Foreign trade starts here!" },
    seg_comex_3:    { name:"COMEX: Trainee Broker",       desc:"3 COMEX missions. Docs and negotiations in English!" },
    seg_corporativo_1:{ desc:"First Corporate mission. The boardroom is yours!" },
    seg_corporativo_3:{ desc:"3 Corporate missions. English meetings with confidence!" },
    seg_transporte_1: { name:"Transport: Route Started",  desc:"First Transport mission. The route begins here!" },
    seg_transporte_3: { name:"Transport: Bilingual Driver",desc:"3 Transport missions. International passengers, hop in!" },
    seg_saude_1:    { name:"Healthcare: Chart Opened",    desc:"First Healthcare mission. Medical English starts here!" },
    seg_saude_3:    { name:"Healthcare: English Resident", desc:"3 Healthcare missions. Precise English care — lives in good hands!" },
    seg_aeroporto_1:{ name:"Airport: Gate Open",          desc:"First Airport mission. Boarding pass in English, please!" },
    seg_aeroporto_3:{ name:"Airport: Ground Staff Trainee",desc:"3 Airport missions. Passengers served with excellence!" },
    seg_cruzeiros_1:{ name:"Cruises: Gangway Open",       desc:"First Cruises mission. All aboard — welcome to the ship!" },
    seg_cruzeiros_3:{ name:"Cruises: Trainee Crew Member",desc:"3 Cruises missions. Passengers on board in good hands!" },
    seg_varejo_1:   { name:"Retail: Store Open",          desc:"First Retail mission. The store is open — welcome, customer!" },
    seg_varejo_3:   { name:"Retail: Sales Trainee",       desc:"3 Retail missions. International customers served with flair!" },
    seg_offshore_1: { name:"Offshore: Platform Online",   desc:"First Offshore mission. All systems go — English activated!" },
    seg_offshore_3: { name:"Offshore: Technician in Training", desc:"3 Offshore missions. Operations in English, fully under control!" },
  },
  es: { _cat: { momento:"⚡ Momento", performance:"🔥 Rendimiento", resiliencia:"⚔️ Resiliencia",
                dominio:"🧠 Dominio", raro:"👑 Raro", jogos:"🎮 Juegos", segmento:"🗺️ Segmento" } },
  de: { _cat: { momento:"⚡ Moment",  performance:"🔥 Leistung",     resiliencia:"⚔️ Ausdauer",
                dominio:"🧠 Meisterschaft", raro:"👑 Selten", jogos:"🎮 Spiele", segmento:"🗺️ Bereich" } },
  it: { _cat: { momento:"⚡ Momento", performance:"🔥 Performance",  resiliencia:"⚔️ Resilienza",
                dominio:"🧠 Dominio", raro:"👑 Raro", jogos:"🎮 Giochi", segmento:"🗺️ Segmento" } },
};
